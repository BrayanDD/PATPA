        ...
        <div class="contenedor_categoria">
                ...
                ?>
                    ...
                    <div class="categoria">
                        ...
                        while($fila_articulo_empresa = $articulo_categoria->fetch_assoc()) {
                            
                                ?>
                                <div class="articulos" data-id="<?= $fila_articulo_empresa['id'] ?>">
                                    <div class="imagen_articulo">
                                        <img src="../../<?= $fila_articulo_empresa['imagen'] ?>" alt="">
                                    </div>
                                    <div class="informacion_articulo">
                                        <h2><?= $fila_articulo_empresa['nombre'] ?></h2>
                                        <h4><?= $fila_articulo_empresa['nombre_empresa'] ?></h4>
                                        <p><?= $fila_articulo_empresa['nombre_categoria'] ?></p>
